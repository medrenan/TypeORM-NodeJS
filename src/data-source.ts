...
const AppDataSource = new DataSource({
    database: 'mkzgjrqm', // se for SQLite, então use bdaula.db
    ...
    username: 'mkzgjrqm', // não use esta propriedade se for sqlite
    password:'1kaTCH3Sn_gcW-kGYN7VgjMjOwwxtDJG', // não use esta propriedade se for sqlite
